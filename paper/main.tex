...
Table \ref{tab:performance_comparison} compares the predictive accuracy and computational complexity of the evaluated architectures. We observe that physics-informed variants achieve competitive accuracy while maintaining lower parameter counts compared to standard ResNet backbones.
